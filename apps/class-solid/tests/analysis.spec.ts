...
test('test', async ({ page }) => {
  ...
  await experiment1.getByRole('button', { name: 'Run' }).click();

  // Add a permutation
  await experiment1.getByTitle("Add a permutation to the reference configuration of this experiment").click();
